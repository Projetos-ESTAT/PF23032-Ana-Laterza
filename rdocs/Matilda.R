...
wordcloud(words = grupo1$palavra,scale = c(3,0.5), freq = grupo1$frequencia,colors = rev(cores_estat)) 
...
wordcloud(words = grupo2$palavra,scale = c(3,.5), freq = grupo2$frequencia,colors = rev(cores_estat)) # tá dando erro essa merda de nuvem
...
wordcloud(words = grupo3$palavra,scale = c(3,.5), freq = grupo3$frequencia,colors = rev(cores_estat)) # tá dando erro essa merda de nuvem
...
wordcloud(words = grupo_n$palavra,scale = c(3,.5), freq = grupo_n$frequencia,colors = rev(cores_estat)) # tá dando erro essa merda de nuvem
